...
namespace CRUD
{
    class Program
    {
        ...
        static void Menu(List<Karyawan> karyawaan)
        {
            bool status = true;
            ...
            do
            {
                ...
                Console.WriteLine("Selamat Mengunjungi Data PT.Munzalan\n");
                Console.WriteLine("Nomor Menu Data: ");
                ...
                {
                    Console.WriteLine("Pilihan tidak ada, Silahkan masukkan pilihan yg tersedia ");
                    goto ifFalseOption;
                }
            }
            while (status);
